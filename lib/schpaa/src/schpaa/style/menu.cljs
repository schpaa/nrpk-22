...
(o/defstyled boatinput-panel-from-right :div
  [:& :p-2 :mx-auto :w-68 :focus:outline-none :outline-none
   {:border                    "1px solid var(--surface1)"
    :background                "var(--surface0)"
    :xfilter                   "drop-shadow(0 0.52rem 0.25rem rgba(0, 0, 0, 0.2))"
    :box-shadow                "0px 12px 10px -8px rgba(0, 0, 0, 0.3)"
    :border-top-left-radius    "var(--radius-3)"
    :border-bottom-left-radius "var(--radius-3)"
    ;:border-radius "var(--radius-3)"
    :xbox-shadow               "var(--shadow-3)"}])

(o/defstyled boatinput-panel-from-bottom :div
  [:& :p-2 :mx-auto :w-68 :focus:outline-none :outline-none :mb-24 :pointer-events-auto
   {:border                  "1px solid var(--surface1)"
    :background              "var(--surface0)"
    :xfilter                 "drop-shadow(0 0.52rem 0.25rem rgba(0, 0, 0, 0.2))"
