...
(o/defstyled cta-color :div
  [:&
   {:background-color "var(--brand1)"                       ;"var(--buttoncta1)"
...
(o/defstyled cta base
  [:&
   {:background-color "var(--brand1)"
    :color            "var(--brand1-copy)"}
   [:&:enabled:hover hover-shadow {:background-color "var(--brand1-hover)"}]
   [:&:enabled:active {:background-color "var(--brand1-hover)"}]
   [:&:disable {:opacity 0.5}]])
...
(o/defstyled outline base
  [:&
   {:border "2px solid var(--buttontext)"
    :color  "var(--buttontext)"}
   [:&:enabled:hover hover-shadow {:color             "var(--buttonbase-hover)"
                                   :-background-color "var(--buttonbase-hover)"}]
   [:&:eanbled:active {:-background-color "var(--buttonbase-active)"
                       :color             "var(--buttonbase-active)"}]])
...
(o/defstyled danger-regular danger
  [:& regular])
