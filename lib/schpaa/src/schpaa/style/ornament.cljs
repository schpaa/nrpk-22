...
(o/defstyled colours :span
  {:color        "white"
   :background   "black"
   :border-color "none" #_"var(--red-5)"})

(o/defstyled markdown :div
  [:s* {:x-webkit-font-smoothing  :auto
  ...
  [#{:p :ul :ol} {:color         "var(--text3)"
                  :padding-block "var(--size-2)"}]
  [:a {:font-family     "unset"
       :font-weight     "var(--font-weight-4)"
       :text-decoration :underline
       :color           "var(--brand2)"}]
  [:h1 :h2 :h3 :h4 :h5 :h6 :text-gray-900]
  [:h3 :text-gray-900
   {:font-weight "var(--font-weight-6)"
    :line-height "var(--font-lineheight-4)"
    :margin-top  "var(--size-3)"
    :font-size   "var(--font-size-2)"}]
  [:h1 :h2 :h3 :h4 :h5 :h6 :-tracking-tight {:font-family "Inter"}]
  [:h1 {:-padding-top "var(--size-8)"
  ...
  [:h2
   {:font-size   "var(--font-size-3)"
    ...
    :font-weight "var(--font-weight-2)"}
   [:a {:font-weight     "var(--font-weight-4)"
        :text-decoration :underline}]]
  ...
  [:ol
   ...
   [:li {:list-style-type "none"
    ...
    ["&::before" colours {:display           :inline-flex
                          :font-weight       "var(--font-weight-6)"
                          :align-items       :center
