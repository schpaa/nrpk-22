...
(o/defstyled surface-instillinger :button
  [:& :-mx-4x :px-4
   scb2/focus-button
   {:height        "auto"
    :text-align    "left"
    :border-radius "var(--radius-1)"}
   [:&.open {:background "var(--floating)"
...
(o/defstyled with-focus :div
  [:&.focused
   {:border-radius "var(--radius-1)"
    :box-shadow    "0px 0px 3px 3px var(--brand2-weak)"}
   ["&:hover:not(.focused)"
    {:color            "var(--gray-9)"
     :border-radius    "var(--radius-1)"
