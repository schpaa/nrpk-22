...
(o/defstyled datetimelink-sans-size :div
  [:& :cursor-pointer
   {:display               :inline-block
    ...
    :text-indent           "0"
    :font-family           "unset"
    :font-weight           "unset"                          ;"var(--font-weight-3)"
...
(o/defstyled surface-a :div
  :p-4
  {:background-color    "white" ;"var(--floating)"
...
(o/defstyled surface-p :div
  [:& :select-none :m-0
   :flex :items-start
   {;:height "100%"
    ;:min-height       "3rem"
    :background-color "red";"var(--toolbar)"
    :padding          "0.5rem"
    ;:background-color "var(--floating)"
    :box-shadow       "var(--shadow-0)"
    :border-radius    "var(--radius-1)"}
   #_#_#_[:&.focus {:background-color "var(--yellow-3)"}]
   [:&.top {:border-top-left-radius  "var(--radius-0)"
            :border-top-right-radius "var(--radius-0)"}]
   [:&.bottom {:border-bottom-left-radius  "var(--radius-0)"
...
#_(o/defstyled dialog-title' :div
    {:color       "var(--text1)"
     ;:padding-block "var(--size-1)"
     :font-family "Sans-serif"
     :font-weight "var(--font-weight-3)"
...
(o/defstyled zebra :div
  ...
  ["&:nth-child(odd)"
   {:background-color "rgba(0,0,0,0.05)"}]
  [:&.selected {:background "var(--blue-3)"}])
...
(o/defstyled grid :div
  {:width                 "100%"
   ...
   :xgrid-auto-columns    "1fr"})

(o/defstyled sample-123 :div
