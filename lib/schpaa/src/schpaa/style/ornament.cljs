...
(o/defstyled subtext-inline :div
  {
   :color       "var(--text2)"
   :font-size   "var(--font-size-1)"
   :font-weight "var(--font-weight-3)"})
...
(o/defstyled subtext-with-link :a
  [:& link
   {;:color           "var(--text3)"
    ...
    :font-size   "var(--font-size-1)"
    :font-weight "var(--font-weight-4)"}
   [:&.dark {:color "var(--brand1)"}
    [:&:enabled:hover {:color "white" #_"var(--brand1-bright)"}]]
   [:&:enabled:hover {:color "var(--brand1-bright)"}]])
...
(o/defstyled dialog :div
  :min-w-md :shadow-xl :rounded-b-xl
  {:border           "1px solid var(--surface1)"
   :color            "var(--text1)"
...
(o/defstyled centered-dialog :div
...
(o/defstyled dropdown-dialog :div
  {:background                 "var(--content)"
   :padding                    "var(--size-6)"
...
(o/defstyled thing-inside-shade :div
  ...
  {:display        :flex
   ...
   :color          "var(--surface3)"}
  [:&:enabled:hover {:background "var(--field1)"
                     :color      "var(--text1)"}]
