            ...
            [:div.text-center
             [ui/transition-child
              {:enter      "ease-out duration-300"
               ...
               :leave-to   "opacity-0"}
              [ui/dialog-overlay {:class "fixed inset-0 bg-gray-900 bg-opacity-75"}]
              #_[ui/dialog-overlay {:style {:background "var(--surface1)"}
             ...
             [ui/transition-child
              ...
              [sc/selector {:style {:box-shadow "var(--shadow-6)"}
                            :class [:xoverflow-y-auto :xmax-h-screen :-translate-y-24x :overflow-hidden]}
               (if content-fn
