(ns schpaa.modal ;eykt.modal
  (:require [schpaa.icon :as icon]
            [schpaa.modal.msg :as msg]
            [eykt.fsm-helpers :refer [send]]))

(def error-message msg/error-message)
(def confirm-action msg/confirm-action)
(def are-you-sure? msg/are-you-sure?)
(def are-you-sure-forced? msg/are-you-sure-forced?)
(def are-you-sure-cover-and-forced? msg/are-you-sure-cover-and-forced?)
