  ...
  ([panel]
   (let [p- [:text-xs :leading-6]                           ;intent minor unimportant text
         ...
         color-map {;intent Utils
                    ...
                    :header                     (conj
                                                  defaults
                                                  {:br  [:border-gray-300 :border-0 :dark:border-gray-600]
                                                   :bg  [:bg-gray-300 :dark:bg-gray-800 :xshadow :active:bg-gray-100]
                    ...
                    :listitem                   (conj
                                                  {:fg- [:text-info-400 "dark:text-info-200/50"] ;intent unimportant / disabled?
