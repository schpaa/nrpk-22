         ...
         color-map {;intent Utils
                    ...
                    :button                 (conj
                                              {:bg+ [:bg-info-100 :hover:bg-info-300 :dark:bg-info-400 :dark:hover:bg-info-500]
                                               :bg  [:bg-info-200 :hover:bg-info-200 :dark:bg-info-400 :dark:hover:bg-info-500]
                                               :bg- [:bg-info-100 :dark:bg-info-600 :hover:bg-info-200 :active:bg-info-300]
                                               :bgt ["bg-info-100/50" :dark:bg-info-600 :hover:bg-info-200 :active:bg-info-300]
                                               :fg  [:text-info-900 :dark:text-info-300]
                                               :fg- [:text-info-400 :dark:text-info-900]
                    ...
                    :listitem               (conj
                                              {:fg- [:text-info-400 "dark:text-info-300/50"] ;intent unimportant / disabled?
                                               ...
                                               :bg- ["bg-info-100/50" "dark:bg-info-300/50"] ;deleted
                    ...
                    :field                  (conj {:fg+ [:text-info-500 :dark:text-info-300] ;field-label
                                                   ...
                                                   :bg- [:bg-info-200 :dark:bg-info-800] ;intent disabled/readonly
                                                   :bg  [:bg-info-50 :dark:bg-info-600]
                                                   :bg+ [:bg-info-300 :dark:bg-info-500]}
                                                  defaults)
                    :field-label            (conj {:fg  [:text-info-500 :dark:text-info-300] ;field-label
                                                   :fg- [:text-info-400 :dark:text-info-300]} ;intent disabled/readonly
                                                  defaults)}
