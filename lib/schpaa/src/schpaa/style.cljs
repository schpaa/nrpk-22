  ...
  ([panel]
   (let [p- [:text-xs :leading-6]                           ;intent minor unimportant text
         ...
         color-map {;intent Utils
                    ...
                    :master-header              (conj defaults
                                                      {:bg- [:bg-sky-300 :dark:bg-sky-800
                                                             :hover:bg-sky-200
                                                             :dark:hover:bg-sky-700]
                                                       :bg+ []
                                                       :bg  [:bg-sky-300 :dark:bg-sky-900]

                                                       :fg  ["text-black/80" "dark:text-white/80"]
                                                       :fg+ ["text-black/30" "dark:text-white/50"]})
                    ;intent HEADERS, tab-bars footers
                    :header                     (conj
                                                  defaults
                                                  {:br  [:border-gray-700 :dark:border-gray-300]
                                                   :bg  [:bg-gray-300 :dark:bg-gray-800]
                                                   :fg+ [:text-gray-700 :dark:text-gray-100 :font-medium]
                                                   :fg- [:text-gray-500 :dark:text-gray-400]
                                                   :fg  [:text-gray-600 :dark:text-gray-400
                                                         ;:dark:active:text-gray-100
                                                         ;:active:text-gray-900
                                                         ;:hover:text-gray-900
                                                         #_:dark:hover:text-gray-100]
                                                   :hl  [:text-alt :dark:text-alt] ;;highlight
                                                   :us  [:text-gray-700 :dark:text-gray-300] ;;unselected
                    ...
                    :surface                    (conj
                                                  ...
                                                  {:fg+ [:text-gray-900 :dark:text-gray-300]
                                                   ...
                                                   ;:br  [:border-gray-500 :border-2 :dark:border-gray-600]
                                                   :br  [:shadow-inner]
                                                   :bg  [:bg-gray-300 :dark:bg-gray-800]
                                                   :bg- [:bg-gray-400 "dark:bg-gray-500/50"]
                                                   :bg+ [:bg-gray-200 :dark:bg-gray-700]})

                    :tabbar                     (conj
                                                  defaults
                                                  {:br+ [:border-alt :border-b-4] ;selected bottom border
                                                   :br- [:border-transparent :border-b-4] ;unselected bottom border
                                                   :br  [:border-gray-400 :dark:border-gray-600] ;; lined bottom border
                    ...
                    :listitem-button-selected   (conj defaults {:bg- [:bg-info-100 :dark:bg-info-700]
                                                                :bg  [:bg-info-200 :dark:bg-info-600]
                                                                :fg  [:text-info-900 :dark:text-info-900]
                                                                :fg- [:text-info-700 :dark:text-info-700]})

                    :listitem-button-unselected (conj defaults {:bg- [:bg-gray-100 :dark:bg-gray-900]
                                                                :bg  [:bg-gray-100 :dark:bg-gray-800]
                                                                :fg  [:text-gray-700 :dark:text-gray-100]
                                                                :fg- [:text-gray-600 :dark:text-gray-300]})

                    ;intent ? elements? list-items?
                    :listitem                   (conj
                                                  {:fg- [:text-info-300 "dark:text-info-200/50"] ;intent unimportant / disabled?
                                                   :fg  [:text-info-700 :dark:text-info-200] ;intent normal
                                                   :fg+ [:text-info-900 :dark:text-info-200] ;intent important
                                                   :bg  [:bg-info-100 :dark:bg-info-900]
                                                   :bg- ["bg-info-100/40" "dark:bg-info-800/50"] ;deleted
                                                   :bg+ [:bg-sky-300 :dark:bg-sky-800]} ;intent SELECTED or highlighted
                                                  defaults)

                    :booking-listitem           (conj
                                                  {:fg- [:text-gray-500 "dark:text-black/50"] ;intent unimportant / disabled?
                                                   :fg  [:text-gray-700 :dark:text-sky-400 :font-medium] ;intent normal
...
(defn prose-markdown-styles [content]
  [:div.prose {:class [:dark:prose-invert
                       :prose-stone
                       ...
                       :dark:prose-headings:text-gray-400

                       :prose-h3:font-semibold
                       :prose-h3:text-xl
                       :prose-h3:tracking-tighter
                       :prose-h3:pt-4
                       :prose-h3:pb-2
                       ...
                       :prose-a:text-alt
                       :hover:prose-a:text-alt-600
                       :dark:hover:prose-a:text-alt-400
