         ...
         color-map {;intent Utils
                    ...
                    :button                (conj
                                             {:bg  [:bg-gray-200 :hover:bg-gray-300 :dark:bg-gray-400 :dark:hover:bg-gray-500]
                                              :bg- [:bg-gray-100 :dark:bg-gray-600 :hover:bg-gray-200 :active:bg-gray-300]
                                              :bgt ["bg-gray-100/50" :dark:bg-gray-600 :hover:bg-gray-200 :active:bg-gray-300]
                                              :fg  [:text-gray-900 :dark:text-gray-300]
                                              :fg- [:text-gray-300 :dark:text-gray-900]
                                              :br  [:border-gray-300 :border-2 :dark:border-gray-500 :rounded-sm]
                                              :bgc [:bg-transparent]
