...
var G__72407 = o;
reagent.impl.template.goog$module$goog$object.set(G__72407,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__72425__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__72425 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__72426__i = 0, G__72426__a = new Array(arguments.length -  0);
while (G__72426__i < G__72426__a.length) {G__72426__a[G__72426__i] = arguments[G__72426__i + 0]; ++G__72426__i;}
  args = new cljs.core.IndexedSeq(G__72426__a,0,null);
} 
return G__72425__delegate.call(this,args);};
G__72425.cljs$lang$maxFixedArity = 0;
G__72425.cljs$lang$applyTo = (function (arglist__72427){
var args = cljs.core.seq(arglist__72427);
return G__72425__delegate(args);
});
G__72425.cljs$core$IFn$_invoke$arity$variadic = G__72425__delegate;
return G__72425;
})()
;
} else {
...
var G__72408 = o;
reagent.impl.template.goog$module$goog$object.set(G__72408,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__72428__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__72428 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__72429__i = 0, G__72429__a = new Array(arguments.length -  0);
while (G__72429__i < G__72429__a.length) {G__72429__a[G__72429__i] = arguments[G__72429__i + 0]; ++G__72429__i;}
  args = new cljs.core.IndexedSeq(G__72429__a,0,null);
} 
return G__72428__delegate.call(this,args);};
G__72428.cljs$lang$maxFixedArity = 0;
G__72428.cljs$lang$applyTo = (function (arglist__72430){
var args = cljs.core.seq(arglist__72430);
return G__72428__delegate(args);
});
G__72428.cljs$core$IFn$_invoke$arity$variadic = G__72428__delegate;
return G__72428;
})()
;
} else {
...
var G__72409 = props;
var G__72409__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__72409,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__72409);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__72409__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5043__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__72410 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__72410,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__72410;
}
})(),id_class);
...
var G__72411 = (cljs.core.count(argv) - first_child);
switch (G__72411) {
case (0):
...
var vec__72412 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__72412,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__72412,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__72412,(2),null);
...
var temp__5757__auto___72438 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___72438 == null)){
} else {
var key_72439 = temp__5757__auto___72438;
(jsprops.key = key_72439);
}
...
var temp__5757__auto___72440 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___72440 == null)){
} else {
var key_72441 = temp__5757__auto___72440;
(jsprops.key = key_72441);
}
...
var temp__5757__auto___72442 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5757__auto___72442 == null)){
} else {
var key_72443 = temp__5757__auto___72442;
(jsprops.key = key_72443);
}
...
var temp__5757__auto___72444 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___72444 == null)){
} else {
var key_72445 = temp__5757__auto___72444;
(jsprops.key = key_72445);
}
...
var temp__5757__auto___72447 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___72447 == null)){
} else {
var key_72449 = temp__5757__auto___72447;
(jsprops.key = key_72449);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__72415_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__72415_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__72416 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__72416,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__72416,(1),null);
...
break;
default:
var G__72451 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__72452 = compiler;
v = G__72451;
compiler = G__72452;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template72422 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template72422 = (function (opts,id,fn_to_element,parse_fn,meta72423){
this.opts = opts;
this.id = id;
this.fn_to_element = fn_to_element;
this.parse_fn = parse_fn;
this.meta72423 = meta72423;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(reagent.impl.template.t_reagent$impl$template72422.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_72424,meta72423__$1){
var self__ = this;
var _72424__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template72422(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta72423__$1));
}));

(reagent.impl.template.t_reagent$impl$template72422.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_72424){
var self__ = this;
var _72424__$1 = this;
return self__.meta72423;
}));

(reagent.impl.template.t_reagent$impl$template72422.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template72422.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template72422.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template72422.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template72422.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template72422.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta72423","meta72423",-1332297720,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template72422.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template72422.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template72422");

(reagent.impl.template.t_reagent$impl$template72422.cljs$lang$ctorPrWriter = (function (this__5327__auto__,writer__5328__auto__,opt__5329__auto__){
return cljs.core._write(writer__5328__auto__,"reagent.impl.template/t_reagent$impl$template72422");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template72422.
 */
reagent.impl.template.__GT_t_reagent$impl$template72422 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template72422(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta72423){
return (new reagent.impl.template.t_reagent$impl$template72422(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta72423));
});

}

return (new reagent.impl.template.t_reagent$impl$template72422(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
