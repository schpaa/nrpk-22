...
var node = (function (){var G__70976 = new cljs.core.Keyword(null,"style","style",-496642736);
var G__70977 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"id","id",-1388402092),"cljs-test-display-style"], null);
var G__70978 = style_string_71087;
return (cljs_test_display.core.n.cljs$core$IFn$_invoke$arity$3 ? cljs_test_display.core.n.cljs$core$IFn$_invoke$arity$3(G__70976,G__70977,G__70978) : cljs_test_display.core.n.call(null,G__70976,G__70977,G__70978));
})();
...
var len__5766__auto___71090 = arguments.length;
var i__5767__auto___71092 = (0);
while(true){
if((i__5767__auto___71092 < len__5766__auto___71090)){
args__5772__auto__.push((arguments[i__5767__auto___71092]));

var G__71093 = (i__5767__auto___71092 + (1));
i__5767__auto___71092 = G__71093;
continue;
} else {
}
break;
...
return cljs_test_display.core.n.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__5773__auto__);
});
...
/** @this {Function} */
(cljs_test_display.core.n.cljs$lang$applyTo = (function (seq70980){
var G__70981 = cljs.core.first(seq70980);
var seq70980__$1 = cljs.core.next(seq70980);
var G__70982 = cljs.core.first(seq70980__$1);
var seq70980__$2 = cljs.core.next(seq70980__$1);
var self__5751__auto__ = this;
return self__5751__auto__.cljs$core$IFn$_invoke$arity$variadic(G__70981,G__70982,seq70980__$2);
}));
...
var vec__70992 = ((clojure.string.starts_with_QMARK_(cljs.core.first(classes),"#"))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$2(cljs.core.first(classes),(1)),cljs.core.rest(classes)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,classes], null));
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__70992,(0),null);
var classes__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__70992,(1),null);
var G__70996 = cljs.core.PersistentArrayMap.EMPTY;
var G__70996__$1 = (cljs.core.truth_(id)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__70996,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__70996);
if(cljs.core.truth_(cljs.core.not_empty(classes__$1))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__70996__$1,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.cljs$core$IFn$_invoke$arity$2(" ",classes__$1));
} else {
return G__70996__$1;
}
} else {
...
return (function() { 
var G__71096__delegate = function (klass,contents){
var vec__70997 = (((klass instanceof cljs.core.Keyword))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [klass,contents], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,cljs.core.cons(klass,contents)], null));
var klass__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__70997,(0),null);
var contents__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__70997,(1),null);
...
var G__71096 = function (klass,var_args){
var contents = null;
if (arguments.length > 1) {
var G__71097__i = 0, G__71097__a = new Array(arguments.length -  1);
while (G__71097__i < G__71097__a.length) {G__71097__a[G__71097__i] = arguments[G__71097__i + 1]; ++G__71097__i;}
  contents = new cljs.core.IndexedSeq(G__71097__a,0,null);
} 
return G__71096__delegate.call(this,klass,contents);};
G__71096.cljs$lang$maxFixedArity = 1;
G__71096.cljs$lang$applyTo = (function (arglist__71098){
var klass = cljs.core.first(arglist__71098);
var contents = cljs.core.rest(arglist__71098);
return G__71096__delegate(klass,contents);
});
G__71096.cljs$core$IFn$_invoke$arity$variadic = G__71096__delegate;
return G__71096;
})()
;
});
...
cljs_test_display.core.process_file_name = (function cljs_test_display$core$process_file_name(p__71013){
var map__71014 = p__71013;
var map__71014__$1 = cljs.core.__destructure_map(map__71014);
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__71014__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__71014__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
cljs_test_display.core.comparison = (function cljs_test_display$core$comparison(p__71036){
var map__71037 = p__71036;
var map__71037__$1 = cljs.core.__destructure_map(map__71037);
var actual = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__71037__$1,new cljs.core.Keyword(null,"actual","actual",107306363));
var expected = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__71037__$1,new cljs.core.Keyword(null,"expected","expected",1583670997));
...
cljs_test_display.core.error_comparison = (function cljs_test_display$core$error_comparison(p__71046){
var map__71047 = p__71046;
var map__71047__$1 = cljs.core.__destructure_map(map__71047);
var expected = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__71047__$1,new cljs.core.Keyword(null,"expected","expected",1583670997));
var actual = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__71047__$1,new cljs.core.Keyword(null,"actual","actual",107306363));
...
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(cljs_test_display.core.state,cljs.core.update,new cljs.core.Keyword(null,"current-node","current-node",-814308842),(function (p1__71050_SHARP_){
return cljs.core.cons(new_current_node,p1__71050_SHARP_);
}));
...
var curr_node = cljs_test_display.core.current_node();
var map__71053 = cljs_test_display.core.current_var_info();
var map__71053__$1 = cljs.core.__destructure_map(map__71053);
var info = map__71053__$1;
...
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(cljs_test_display.core.state,cljs.core.update,new cljs.core.Keyword(null,"current-node","current-node",-814308842),(function (p1__71051_SHARP_){
return cljs.core.cons(node,p1__71051_SHARP_);
}));

return goog.dom.appendChild(curr_node,node);
});
cljs_test_display.core.summary = (function cljs_test_display$core$summary(p__71054){
var map__71056 = p__71054;
var map__71056__$1 = cljs.core.__destructure_map(map__71056);
var m = map__71056__$1;
var fail = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__71056__$1,new cljs.core.Keyword(null,"fail","fail",1706214930));
var error = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__71056__$1,new cljs.core.Keyword(null,"error","error",-978969032));
var pass = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__71056__$1,new cljs.core.Keyword(null,"pass","pass",1574159993));
var test = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__71056__$1,new cljs.core.Keyword(null,"test","test",577538877));
...
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["expected:",(function (){var G__71066 = new cljs.core.Keyword(null,"expected","expected",1583670997).cljs$core$IFn$_invoke$arity$1(m);
return (formatter_fn.cljs$core$IFn$_invoke$arity$1 ? formatter_fn.cljs$core$IFn$_invoke$arity$1(G__71066) : formatter_fn.call(null,G__71066));
})()], 0));

return cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["  actual:",(function (){var G__71067 = new cljs.core.Keyword(null,"actual","actual",107306363).cljs$core$IFn$_invoke$arity$1(m);
return (formatter_fn.cljs$core$IFn$_invoke$arity$1 ? formatter_fn.cljs$core$IFn$_invoke$arity$1(G__71067) : formatter_fn.call(null,G__71067));
})()], 0));
});
...
var temp__5753__auto___71110 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5753__auto___71110)){
var message_71111 = temp__5753__auto___71110;
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([message_71111], 0));
} else {
}
...
var temp__5753__auto___71112 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5753__auto___71112)){
var message_71113 = temp__5753__auto___71112;
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([message_71113], 0));
} else {
}
