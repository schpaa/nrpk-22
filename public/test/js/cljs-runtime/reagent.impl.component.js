...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__72293 = c;
var G__72293__$1 = (((G__72293 == null))?null:G__72293.prototype);
if((G__72293__$1 == null)){
return null;
} else {
return G__72293__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__72294 = c;
var G__72294__$1 = (((G__72294 == null))?null:G__72294.prototype);
if((G__72294__$1 == null)){
return null;
} else {
return G__72294__$1.render;
}
})() == null)))));
});
...
return (function() { 
var G__72388__delegate = function (args){
...
var G__72388 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__72389__i = 0, G__72389__a = new Array(arguments.length -  0);
while (G__72389__i < G__72389__a.length) {G__72389__a[G__72389__i] = arguments[G__72389__i + 0]; ++G__72389__i;}
  args = new cljs.core.IndexedSeq(G__72389__a,0,null);
} 
return G__72388__delegate.call(this,args);};
G__72388.cljs$lang$maxFixedArity = 0;
G__72388.cljs$lang$applyTo = (function (arglist__72390){
var args = cljs.core.seq(arglist__72390);
return G__72388__delegate(args);
});
G__72388.cljs$core$IFn$_invoke$arity$variadic = G__72388__delegate;
return G__72388;
})()
;})(c,compiler,f,_,res))
:res);
...
var or__5043__auto__ = (function (){var G__72302 = c;
var G__72302__$1 = (((G__72302 == null))?null:G__72302.constructor);
if((G__72302__$1 == null)){
return null;
} else {
return G__72302__$1.displayName;
}
})();
...
var G__72304 = c;
var G__72304__$1 = (((G__72304 == null))?null:G__72304.constructor);
if((G__72304__$1 == null)){
return null;
} else {
return G__72304__$1.name;
}
}
});
...
var _STAR_current_component_STAR__orig_val__72307 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__72308 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__72308);

try{return reagent.impl.component.wrap_render(c,compiler);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__72307);
}});
reagent.impl.component.rat_opts = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"no-cache","no-cache",1588056370),true], null);
reagent.impl.component.custom_wrapper = (function reagent$impl$component$custom_wrapper(key,f){
var G__72338 = key;
var G__72338__$1 = (((G__72338 instanceof cljs.core.Keyword))?G__72338.fqn:null);
switch (G__72338__$1) {
...
var or__5043__auto__ = reagent.impl.util._STAR_always_update_STAR_;
if(cljs.core.truth_(or__5043__auto__)){
return or__5043__auto__;
} else {
var c = this;
...
var c = this;
var G__72371_72396 = reagent.impl.component.goog$module$goog$object.get(c,"cljsRatom");
if((G__72371_72396 == null)){
} else {
reagent.ratom.dispose_BANG_(G__72371_72396);
}
...
if(cljs.core.truth_((function (){var and__5041__auto__ = wrap;
...
var renders_72397 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_72398 = cljs.core.first(cljs.core.vals(renders_72397));
...
if((cljs.core.count(renders_72397) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_72397))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_72398)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_72398], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__72379 = o;
reagent.impl.component.goog$module$goog$object.set(G__72379,cljs.core.name(k),v);
...
if(reagent.debug.has_console){
((reagent.debug.tracking)?reagent.debug.track_console:console).warn(["Warning: ","Using native React classes directly in Hiccup forms ","is not supported. Use create-element or ","adapt-react-class instead: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var or__5043__auto__ = reagent.impl.util.fun_name(f);
if(cljs.core.truth_(or__5043__auto__)){
return or__5043__auto__;
} else {
return f;
...
return (function() { 
var G__72400__delegate = function (args){
return reagent.impl.protocols.as_element(compiler,cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args));
};
var G__72400 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__72401__i = 0, G__72401__a = new Array(arguments.length -  0);
while (G__72401__i < G__72401__a.length) {G__72401__a[G__72401__i] = arguments[G__72401__i + 0]; ++G__72401__i;}
  args = new cljs.core.IndexedSeq(G__72401__a,0,null);
} 
return G__72400__delegate.call(this,args);};
G__72400.cljs$lang$maxFixedArity = 0;
G__72400.cljs$lang$applyTo = (function (arglist__72402){
var args = cljs.core.seq(arglist__72402);
return G__72400__delegate(args);
});
G__72400.cljs$core$IFn$_invoke$arity$variadic = G__72400__delegate;
return G__72400;
})()
...
var _STAR_current_component_STAR__orig_val__72380 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__72381 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__72381);

try{return reagent.impl.component.functional_wrap_render(compiler,c);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__72380);
}});
...
var vec__72382 = module$node_modules$react$index.useState((0));
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__72382,(0),null);
var update_count = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__72382,(1),null);
...
var G__72385 = reagent.impl.component.goog$module$goog$object.get(reagent_state,"cljsRatom");
if((G__72385 == null)){
return null;
} else {
return reagent.ratom.dispose_BANG_(G__72385);
}
});
}),[]);
...
var and__5041__auto__ = reagent.impl.util._STAR_always_update_STAR_ === false;
if(and__5041__auto__){
try{return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(old_argv,new_argv);
}catch (e72386){var e = e72386;
if(reagent.debug.has_console){
((reagent.debug.tracking)?reagent.debug.track_console:console).warn(["Warning: ","Exception thrown while comparing argv's in shouldComponentUpdate: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(old_argv)," ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(new_argv)," ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(e)].join(''));
} else {
}
...
var or__5043__auto__ = reagent.impl.component.cached_react_class(compiler,tag);
if(cljs.core.truth_(or__5043__auto__)){
return or__5043__auto__;
} else {
