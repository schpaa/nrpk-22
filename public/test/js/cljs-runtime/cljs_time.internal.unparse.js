...
var periods__$1 = cljs.core.vec((function (){var G__73546 = periods;
if(cljs.core.truth_(short_QMARK_)){
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__73544_SHARP_){
return cljs.core.subs.cljs$core$IFn$_invoke$arity$3(p1__73544_SHARP_,(0),(3));
}),G__73546);
} else {
return G__73546;
}
...
cljs_time.internal.unparse.lookup = (function cljs_time$internal$unparse$lookup(p__73561){
var vec__73562 = p__73561;
var t = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__73562,(0),null);
var pattern = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__73562,(1),null);
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(t,new cljs.core.Keyword(null,"token","token",-1211463215))){
var G__73565 = pattern;
switch (G__73565) {
case "S":
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__73565)].join('')));
...
var G__73576 = key;
var G__73576__$1 = (((G__73576 instanceof cljs.core.Keyword))?G__73576.fqn:null);
switch (G__73576__$1) {
case "millis":
return (function (p1__73568_SHARP_){
return p1__73568_SHARP_.getMilliseconds();
});

break;
case "seconds":
return (function (p1__73569_SHARP_){
return p1__73569_SHARP_.getSeconds();
});

break;
case "minutes":
return (function (p1__73570_SHARP_){
return p1__73570_SHARP_.getMinutes();
});

break;
case "hours":
return (function (p1__73571_SHARP_){
return p1__73571_SHARP_.getHours();
});

break;
case "HOURS":
return (function (p1__73572_SHARP_){
return p1__73572_SHARP_.getHours();
});

break;
case "day":
return (function (p1__73573_SHARP_){
return p1__73573_SHARP_.getDate();
});

break;
case "month":
return (function (p1__73574_SHARP_){
return p1__73574_SHARP_.getMonth();
});

break;
case "year":
return (function (p1__73575_SHARP_){
return p1__73575_SHARP_.getYear();
});

break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__73576__$1)].join('')));

}
});
cljs_time.internal.unparse.lookup_fn = (function cljs_time$internal$unparse$lookup_fn(syntax_list,i,p__73579){
var vec__73580 = p__73579;
var seq__73581 = cljs.core.seq(vec__73580);
var first__73582 = cljs.core.first(seq__73581);
var seq__73581__$1 = cljs.core.next(seq__73581);
var key = first__73582;
var args = seq__73581__$1;
var G__73583 = key;
var G__73583__$1 = (((G__73583 instanceof cljs.core.Keyword))?G__73583.fqn:null);
switch (G__73583__$1) {
case "millis":
...
break;
case "ordinal-suffix":
var vec__73586 = (function (){var G__73589 = (i - (1));
return (syntax_list.cljs$core$IFn$_invoke$arity$1 ? syntax_list.cljs$core$IFn$_invoke$arity$1(G__73589) : syntax_list.call(null,G__73589));
})();
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__73586,(0),null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__73583__$1)].join('')));
...
var d = value;
var G__73595 = cljs.core.map_indexed.cljs$core$IFn$_invoke$arity$2(cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs_time.internal.unparse.lookup_fn,syn_list),syn_list);
var vec__73596 = G__73595;
var seq__73597 = cljs.core.seq(vec__73596);
var first__73598 = cljs.core.first(seq__73597);
var seq__73597__$1 = cljs.core.next(seq__73597);
var unparser = first__73598;
var more = seq__73597__$1;
var s = "";
var d__$1 = d;
var G__73595__$1 = G__73595;
var s__$1 = s;
while(true){
var d__$2 = d__$1;
var vec__73607 = G__73595__$1;
var seq__73608 = cljs.core.seq(vec__73607);
var first__73609 = cljs.core.first(seq__73608);
var seq__73608__$1 = cljs.core.next(seq__73608);
var unparser__$1 = first__73609;
var more__$1 = seq__73608__$1;
var s__$2 = s__$1;
if((unparser__$1 == null)){
return s__$2;
} else {
var vec__73610 = (unparser__$1.cljs$core$IFn$_invoke$arity$2 ? unparser__$1.cljs$core$IFn$_invoke$arity$2(s__$2,d__$2) : unparser__$1.call(null,s__$2,d__$2));
var s__$3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__73610,(0),null);
var d__$3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__73610,(1),null);
var G__73645 = d__$3;
var G__73646 = more__$1;
var G__73647 = s__$3;
d__$1 = G__73645;
G__73595__$1 = G__73646;
s__$1 = G__73647;
continue;
}
break;
