...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_65269 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_65269(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_65270 = (function (reader){
var x__5390__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_65270(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_65271 = (function (reader,ch){
var x__5390__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_65271(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_65272 = (function (reader){
var x__5390__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_65272(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_65273 = (function (reader){
var x__5390__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_65273(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_65274 = (function (reader){
var x__5390__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_65274(reader);
}
});
...
var G__65294 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__65295 = s.append(c);
c = G__65294;
s = G__65295;
continue;
}
