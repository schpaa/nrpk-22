...
var len__5766__auto___62671 = arguments.length;
var i__5767__auto___62672 = (0);
while(true){
if((i__5767__auto___62672 < len__5766__auto___62671)){
args__5772__auto__.push((arguments[i__5767__auto___62672]));

var G__62673 = (i__5767__auto___62672 + (1));
i__5767__auto___62672 = G__62673;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq62579){
...
return self__5751__auto__.cljs$core$IFn$_invoke$arity$variadic(G__62580,G__62581,seq62579__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__62601_SHARP_){
return (!((cljs.core.meta(p1__62601_SHARP_) == null)));
})))){
...
var map__62614 = opts;
var map__62614__$1 = cljs.core.__destructure_map(map__62614);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62614__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e62617){var _e__33782__auto__ = e62617;
return false;
}})();
if(cljs.core.truth_(or__5043__auto__)){
return or__5043__auto__;
...
}catch (e62620){var _e__33782__auto__ = e62620;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__62633 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__62635 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__62635);
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62637__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__62633);
}});
...
var temp__5751__auto___62697 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5751__auto___62697)){
var managed_print_level_62698 = temp__5751__auto___62697;
var _STAR_print_level_STAR__orig_val__62646_62699 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__62647_62700 = managed_print_level_62698;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__62647_62700);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__62638_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__62638_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__62646_62699);
}} else {
job_fn();
}
