...
reagent.impl.input.input_node_set_value = (function reagent$impl$input$input_node_set_value(node,rendered_value,dom_value,component,p__72394){
var map__72395 = p__72394;
var map__72395__$1 = cljs.core.__destructure_map(map__72395);
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__72395__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
if(cljs.core.truth_((function (){var and__5041__auto__ = (!((jsprops == null)));
if(and__5041__auto__){
var and__5041__auto____$1 = jsprops.hasOwnProperty("onChange");
...
}):(cljs.core.truth_((function (){var and__5041__auto__ = original_ref_fn;
...
(jsprops.onChange = (function (p1__72399_SHARP_){
return reagent.impl.input.input_handle_change(this$,on_change,p1__72399_SHARP_);
}));
