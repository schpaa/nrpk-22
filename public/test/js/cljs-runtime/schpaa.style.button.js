...
schpaa.style.button.round_normal_listitem = lambdaisland.ornament.styled(new cljs.core.Symbol("schpaa.style.button","round-normal-listitem","schpaa.style.button/round-normal-listitem",2142035750,null),"schpaa_style_button__round_normal_listitem",new cljs.core.Keyword(null,"button","button",1456579943),null,null);
schpaa.style.button.round_undo_listitem = lambdaisland.ornament.styled(new cljs.core.Symbol("schpaa.style.button","round-undo-listitem","schpaa.style.button/round-undo-listitem",-231074218,null),"schpaa_style_button__round_undo_listitem",new cljs.core.Keyword(null,"button","button",1456579943),null,null);
schpaa.style.button.static_listitem = lambdaisland.ornament.styled(new cljs.core.Symbol("schpaa.style.button","static-listitem","schpaa.style.button/static-listitem",390106939,null),"schpaa_style_button__static_listitem",new cljs.core.Keyword(null,"div","div",1057191632),null,null);
schpaa.style.button.round_danger_listitem = lambdaisland.ornament.styled(new cljs.core.Symbol("schpaa.style.button","round-danger-listitem","schpaa.style.button/round-danger-listitem",1064567873,null),"schpaa_style_button__round_danger_listitem",new cljs.core.Keyword(null,"button","button",1456579943),null,null);
schpaa.style.button.round_mainpage = lambdaisland.ornament.styled(new cljs.core.Symbol("schpaa.style.button","round-mainpage","schpaa.style.button/round-mainpage",-493602591,null),"schpaa_style_button__round_mainpage",new cljs.core.Keyword(null,"div","div",1057191632),null,null);
schpaa.style.button.round_dark = lambdaisland.ornament.styled(new cljs.core.Symbol("schpaa.style.button","round-dark","schpaa.style.button/round-dark",2019010078,null),"schpaa_style_button__round_dark",new cljs.core.Keyword(null,"div","div",1057191632),null,null);
schpaa.style.button.corner = lambdaisland.ornament.styled(new cljs.core.Symbol("schpaa.style.button","corner","schpaa.style.button/corner",1351111879,null),"schpaa_style_button__corner",new cljs.core.Keyword(null,"button","button",1456579943),null,null);

//# sourceMappingURL=schpaa.style.button.js.map
