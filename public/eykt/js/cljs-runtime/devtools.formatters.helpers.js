...
var G__41978 = devtools.prefs.pref(v);
v = G__41978;
continue;
} else {
return v;
...
}catch (e41901){var _e__40992__auto__ = e41901;
return false;
}})();
...
}catch (e41910){var _e__40992__auto__ = e41910;
return false;
}})();
...
}catch (e41915){var _e__40992__auto__ = e41915;
return false;
}}
}
});
...
var vec__41949 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41949,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41949,(1),null);
...
return cljs.core.some((function (p1__41960_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__41960_SHARP_);
}),template);
});
