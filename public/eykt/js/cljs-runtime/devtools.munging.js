...
var o41637 = temp__5751__auto__;
var temp__5751__auto____$1 = (o41637["core"]);
if(cljs.core.truth_(temp__5751__auto____$1)){
var o41638 = temp__5751__auto____$1;
return (o41638["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__40959__auto__ = f;
return (o__40959__auto__["toString"]).call(o__40959__auto__);
} else {
return "";
}
}catch (e41648){var _ = e41648;
return "";
}});
...
try{var o__40959__auto___41891 = t;
(o__40959__auto___41891["cljs$lang$ctorPrWriter"]).call(o__40959__auto___41891,t,writer);
}catch (e41657){var __41892 = e41657;
}
...
var char_code = (function (){var o__40959__auto__ = (new String(char$));
return (o__40959__auto__["charCodeAt"]).call(o__40959__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__40959__auto__ = String;
return (o__40959__auto__["fromCharCode"]).call(o__40959__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__41663 = num_code;
switch (G__41663) {
case (1):
return (185);
...
var o__40959__auto__ = String;
return (o__40959__auto__["fromCharCode"]).call(o__40959__auto__,superscript_code);
});
/**
...
}catch (e41675){var _e__40992__auto__ = e41675;
return false;
}})())){
...
var vec__41678 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41678,(0),null);
...
var len__4864__auto___41913 = arguments.length;
var i__4865__auto___41914 = (0);
while(true){
if((i__4865__auto___41914 < len__4864__auto___41913)){
args__4870__auto__.push((arguments[i__4865__auto___41914]));

var G__41916 = (i__4865__auto___41914 + (1));
i__4865__auto___41914 = G__41916;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__41699){
var vec__41700 = p__41699;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41700,(0),null);
...
var G__41925 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__41926 = cljs.core.butlast(remaining_tokens);
name_tokens = G__41925;
remaining_tokens = G__41926;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq41692){
var G__41693 = cljs.core.first(seq41692);
var seq41692__$1 = cljs.core.next(seq41692);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__41693,seq41692__$1);
}));
...
var vec__41715 = cljs.core.split_with((function (p1__41713_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__41713_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41715,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41715,(1),null);
...
var vec__41730 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41730,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41730,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__41931 = cljs.core.rest(remaining_tokens);
var G__41932 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__41931;
name_tokens = G__41932;
continue;
} else {
...
var vec__41739 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41739,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41739,(1),null);
var vec__41742 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41742,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41742,(1),null);
var vec__41745 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41745,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41745,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41745,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41745,(3),null);
...
var vec__41760 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41760,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41760,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41760,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41760,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41760,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41760,(5),null);
...
if(cljs.core.truth_(temp__5751__auto__)){
var vec__41778 = temp__5751__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41778,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41778,(1),null);
var vec__41781 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41781,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41781,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__41785 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__41785) : devtools.munging.parse_fn_info_deep.call(null,G__41785));
})()));
}
} else {
return fn_info;
...
var G__41971 = (arity + (1));
var G__41972 = (function (){var temp__5751__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5751__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__41790){
var vec__41791 = p__41790;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41791,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41791,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__41797_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__41797_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__41798_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__41798_SHARP_);
}),sorted_infos);
...
var args__4870__auto__ = [];
var len__4864__auto___41979 = arguments.length;
var i__4865__auto___41980 = (0);
while(true){
if((i__4865__auto___41980 < len__4864__auto___41979)){
args__4870__auto__.push((arguments[i__4865__auto___41980]));

var G__41981 = (i__4865__auto___41980 + (1));
i__4865__auto___41980 = G__41981;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__41802){
var vec__41803 = p__41802;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41803,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq41800){
var G__41801 = cljs.core.first(seq41800);
var seq41800__$1 = cljs.core.next(seq41800);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__41801,seq41800__$1);
}));
...
var G__41807 = arg;
var G__41807__$1 = (((G__41807 instanceof cljs.core.Keyword))?G__41807.fqn:null);
switch (G__41807__$1) {
...
var map__41825 = options;
var map__41825__$1 = cljs.core.__destructure_map(map__41825);
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41825__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41825__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41825__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41825__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__41826 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41826,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41826,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41826,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41826,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41826,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41826,(5),null);
...
var o__40959__auto__ = f;
return (o__40959__auto__["getBasis"]).call(o__40959__auto__);
});
/**
...
}catch (e41835){var _e__40992__auto__ = e41835;
...
var G__41998 = (obj[cljs.core.first(path)]);
var G__41999 = cljs.core.rest(path);
obj = G__41998;
path = G__41999;
continue;
} else {
...
var _STAR_ = (function (accum,p__41852){
var vec__41853 = p__41852;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41853,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41853,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__41860){
var vec__41862 = p__41860;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41862,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41862,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41862,(2),null);
...
var post_process = (function (p__41878){
var vec__41879 = p__41878;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41879,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41879,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__41868_SHARP_){
return (obj[cljs.core.first(p1__41868_SHARP_)]);
}),sorted_matches);
