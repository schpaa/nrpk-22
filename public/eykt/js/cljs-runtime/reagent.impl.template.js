...
var G__52109 = o;
reagent.impl.template.goog$module$goog$object.set(G__52109,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__52129__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__52129 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__52130__i = 0, G__52130__a = new Array(arguments.length -  0);
while (G__52130__i < G__52130__a.length) {G__52130__a[G__52130__i] = arguments[G__52130__i + 0]; ++G__52130__i;}
  args = new cljs.core.IndexedSeq(G__52130__a,0,null);
} 
return G__52129__delegate.call(this,args);};
G__52129.cljs$lang$maxFixedArity = 0;
G__52129.cljs$lang$applyTo = (function (arglist__52131){
var args = cljs.core.seq(arglist__52131);
return G__52129__delegate(args);
});
G__52129.cljs$core$IFn$_invoke$arity$variadic = G__52129__delegate;
return G__52129;
})()
;
} else {
...
var G__52110 = o;
reagent.impl.template.goog$module$goog$object.set(G__52110,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__52136__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__52136 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__52137__i = 0, G__52137__a = new Array(arguments.length -  0);
while (G__52137__i < G__52137__a.length) {G__52137__a[G__52137__i] = arguments[G__52137__i + 0]; ++G__52137__i;}
  args = new cljs.core.IndexedSeq(G__52137__a,0,null);
} 
return G__52136__delegate.call(this,args);};
G__52136.cljs$lang$maxFixedArity = 0;
G__52136.cljs$lang$applyTo = (function (arglist__52138){
var args = cljs.core.seq(arglist__52138);
return G__52136__delegate(args);
});
G__52136.cljs$core$IFn$_invoke$arity$variadic = G__52136__delegate;
return G__52136;
})()
;
} else {
...
var G__52111 = props;
var G__52111__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__52111,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__52111);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__52111__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4253__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__52112 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__52112,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__52112;
}
})(),id_class);
...
var G__52113 = (cljs.core.count(argv) - first_child);
switch (G__52113) {
case (0):
...
var vec__52114 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52114,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52114,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52114,(2),null);
...
var temp__5757__auto___52147 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___52147 == null)){
} else {
var key_52148 = temp__5757__auto___52147;
(jsprops.key = key_52148);
}
...
var temp__5757__auto___52151 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___52151 == null)){
} else {
var key_52152 = temp__5757__auto___52151;
(jsprops.key = key_52152);
}
...
var temp__5757__auto___52154 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5757__auto___52154 == null)){
} else {
var key_52157 = temp__5757__auto___52154;
(jsprops.key = key_52157);
}
...
var temp__5757__auto___52160 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___52160 == null)){
} else {
var key_52161 = temp__5757__auto___52160;
(jsprops.key = key_52161);
}
...
var temp__5757__auto___52168 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___52168 == null)){
} else {
var key_52169 = temp__5757__auto___52168;
(jsprops.key = key_52169);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__52117_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__52117_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__52118 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52118,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52118,(1),null);
...
break;
default:
var G__52171 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__52172 = compiler;
v = G__52171;
compiler = G__52172;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template52124 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template52124 = (function (opts,id,fn_to_element,parse_fn,meta52125){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template52124.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_52126,meta52125__$1){
var self__ = this;
var _52126__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template52124(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta52125__$1));
}));

(reagent.impl.template.t_reagent$impl$template52124.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_52126){
var self__ = this;
var _52126__$1 = this;
return self__.meta52125;
}));

(reagent.impl.template.t_reagent$impl$template52124.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template52124.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template52124.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template52124.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template52124.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template52124.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta52125","meta52125",1300846130,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template52124.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template52124.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template52124");

(reagent.impl.template.t_reagent$impl$template52124.cljs$lang$ctorPrWriter = (function (this__4491__auto__,writer__4492__auto__,opt__4493__auto__){
return cljs.core._write(writer__4492__auto__,"reagent.impl.template/t_reagent$impl$template52124");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template52124.
 */
reagent.impl.template.__GT_t_reagent$impl$template52124 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template52124(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta52125){
return (new reagent.impl.template.t_reagent$impl$template52124(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta52125));
});

}

return (new reagent.impl.template.t_reagent$impl$template52124(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
