...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_44332 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_44332(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_44334 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_44334(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_44336 = (function (reader,ch){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_44336(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_44338 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_44338(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_44347 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_44347(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_44355 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_44355(reader);
}
});
...
var G__44394 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__44395 = s.append(c);
c = G__44394;
s = G__44395;
continue;
}
