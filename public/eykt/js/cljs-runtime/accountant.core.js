...
var and__4251__auto____$1 = (function (){var fexpr__43914 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["",null,"_self",null], null), null);
return (fexpr__43914.cljs$core$IFn$_invoke$arity$1 ? fexpr__43914.cljs$core$IFn$_invoke$arity$1(link_target) : fexpr__43914.call(null,link_target));
})();
if(cljs.core.truth_(and__4251__auto____$1)){
 ...
 */
accountant.core.configure_navigation_BANG_ = (function accountant$core$configure_navigation_BANG_(p__43925){
var map__43926 = p__43925;
var map__43926__$1 = cljs.core.__destructure_map(map__43926);
var nav_handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43926__$1,new cljs.core.Keyword(null,"nav-handler","nav-handler",2039495484));
var path_exists_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43926__$1,new cljs.core.Keyword(null,"path-exists?","path-exists?",1473384514));
var reload_same_path_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43926__$1,new cljs.core.Keyword(null,"reload-same-path?","reload-same-path?",1981904231));
...
var seq__43927 = cljs.core.seq(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [accountant.core.document_click_handler_listener_key,accountant.core.navigate_listener_key], null));
var chunk__43928 = null;
var count__43929 = (0);
var i__43930 = (0);
while(true){
if((i__43930 < count__43929)){
var key = chunk__43928.cljs$core$IIndexed$_nth$arity$2(null,i__43930);
...
var G__43954 = seq__43927;
var G__43955 = chunk__43928;
var G__43956 = count__43929;
var G__43957 = (i__43930 + (1));
seq__43927 = G__43954;
chunk__43928 = G__43955;
count__43929 = G__43956;
i__43930 = G__43957;
continue;
} else {
var temp__5753__auto__ = cljs.core.seq(seq__43927);
if(temp__5753__auto__){
var seq__43927__$1 = temp__5753__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__43927__$1)){
var c__4679__auto__ = cljs.core.chunk_first(seq__43927__$1);
var G__43959 = cljs.core.chunk_rest(seq__43927__$1);
var G__43960 = c__4679__auto__;
var G__43961 = cljs.core.count(c__4679__auto__);
var G__43962 = (0);
seq__43927 = G__43959;
chunk__43928 = G__43960;
count__43929 = G__43961;
i__43930 = G__43962;
continue;
} else {
var key = cljs.core.first(seq__43927__$1);
if(cljs.core.truth_(key)){
goog.events.unlistenByKey(key);
} else {
}
...
var G__43963 = cljs.core.next(seq__43927__$1);
var G__43964 = null;
var G__43965 = (0);
var G__43966 = (0);
seq__43927 = G__43963;
chunk__43928 = G__43964;
count__43929 = G__43965;
i__43930 = G__43966;
continue;
}
} else {
...
var params = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__43934_SHARP_){
return cljs.core.name(p1__43934_SHARP_);
...
return clojure.string.join.cljs$core$IFn$_invoke$arity$2("&",cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__43935_SHARP_){
return clojure.string.join.cljs$core$IFn$_invoke$arity$2("=",p1__43935_SHARP_);
}),pairs));
});
/**
...
if(cljs.core.truth_(accountant.core.nav_handler)){
var G__43944 = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(path),cljs.core.str.cljs$core$IFn$_invoke$arity$1(query),cljs.core.str.cljs$core$IFn$_invoke$arity$1(hash)].join('');
return (accountant.core.nav_handler.cljs$core$IFn$_invoke$arity$1 ? accountant.core.nav_handler.cljs$core$IFn$_invoke$arity$1(G__43944) : accountant.core.nav_handler.call(null,G__43944));
} else {
