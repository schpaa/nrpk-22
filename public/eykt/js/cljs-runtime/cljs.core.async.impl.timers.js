...
var i_46504 = (0);
while(true){
if((i_46504 < arr.length)){
(arr[i_46504] = null);

var G__46507 = (i_46504 + (1));
i_46504 = G__46507;
continue;
} else {
}
...
var i_46525 = (self__.level + (1));
while(true){
if((i_46525 <= (new_level + (1)))){
(update[i_46525] = self__.header);

var G__46527 = (i_46525 + (1));
i_46525 = G__46527;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_46531 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_46531[i]));
} else {
x__$2.forward.push((((i < links_46531.length))?(links_46531[i]):null));
}

if((i < links_46531.length)){
(links_46531[i] = x__$2);
} else {
links_46531.push(x__$2);
}
...
var i_46536 = (0);
while(true){
if((i_46536 <= self__.level)){
var links_46539 = (update[i_46536]).forward;
if((x__$1 === (((i_46536 < links_46539.length))?(links_46539[i_46536]):null))){
(links_46539[i_46536] = (x__$1.forward[i_46536]));

var G__46542 = (i_46536 + (1));
i_46536 = G__46542;
continue;
} else {
var G__46543 = (i_46536 + (1));
i_46536 = G__46543;
continue;
}
} else {
...
var G__46564 = nx;
var G__46565 = (level__$1 - (1));
x = G__46564;
level__$1 = G__46565;
continue;
} else {
var G__46567 = x;
var G__46568 = (level__$1 - (1));
x = G__46567;
level__$1 = G__46568;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__46583 = nx;
var G__46584 = (level__$1 - (1));
x = G__46583;
level__$1 = G__46584;
continue;
} else {
var G__46585 = x;
var G__46586 = (level__$1 - (1));
x = G__46585;
level__$1 = G__46586;
continue;
}
