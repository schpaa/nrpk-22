...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first(format),(function (){var G__44449 = cljs.core.second(format);
var G__44450 = format_params;
return (ajax.easy.keyword_response_format_element.cljs$core$IFn$_invoke$arity$2 ? ajax.easy.keyword_response_format_element.cljs$core$IFn$_invoke$arity$2(G__44449,G__44450) : ajax.easy.keyword_response_format_element.call(null,G__44449,G__44450));
})()], null);
} else {
if(cljs.core.map_QMARK_(format)){
return format;
...
if(cljs.core.vector_QMARK_(format)){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.vector,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__44459_SHARP_){
return ajax.easy.keyword_response_format_element(p1__44459_SHARP_,format_params);
}),format));
} else {
 ...
 */
ajax.easy.transform_handler = (function ajax$easy$transform_handler(p__44463){
var map__44465 = p__44463;
var map__44465__$1 = cljs.core.__destructure_map(map__44465);
var handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44465__$1,new cljs.core.Keyword(null,"handler","handler",-195596612));
var error_handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44465__$1,new cljs.core.Keyword(null,"error-handler","error-handler",-484945776));
var finally$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44465__$1,new cljs.core.Keyword(null,"finally","finally",1589088705));
...
return (function ajax$easy$transform_handler_$_easy_handler(p__44466){
var vec__44467 = p__44466;
var ok = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44467,(0),null);
var result = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44467,(1),null);
var fexpr__44470_44481 = (cljs.core.truth_(ok)?h:e);
(fexpr__44470_44481.cljs$core$IFn$_invoke$arity$1 ? fexpr__44470_44481.cljs$core$IFn$_invoke$arity$1(result) : fexpr__44470_44481.call(null,result));
...
ajax.easy.transform_opts = (function ajax$easy$transform_opts(p__44471){
var map__44472 = p__44471;
var map__44472__$1 = cljs.core.__destructure_map(map__44472);
...
var format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44472__$1,new cljs.core.Keyword(null,"format","format",-1306924766));
...
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44472__$1,new cljs.core.Keyword(null,"params","params",710516235));
