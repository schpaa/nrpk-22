...
var ajax$protocols$AjaxImpl$_js_ajax_request$dyn_43993 = (function (this$,request,handler){
...
return ajax$protocols$AjaxImpl$_js_ajax_request$dyn_43993(this$,request,handler);
}
});
...
var ajax$protocols$AjaxRequest$_abort$dyn_43994 = (function (this$){
var x__4550__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxRequest$_abort$dyn_43994(this$);
}
});
...
var ajax$protocols$AjaxResponse$_status$dyn_43995 = (function (this$){
var x__4550__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_status$dyn_43995(this$);
}
});

var ajax$protocols$AjaxResponse$_status_text$dyn_43996 = (function (this$){
var x__4550__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_status_text$dyn_43996(this$);
}
});

var ajax$protocols$AjaxResponse$_get_all_headers$dyn_43997 = (function (this$){
var x__4550__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_get_all_headers$dyn_43997(this$);
}
});

var ajax$protocols$AjaxResponse$_body$dyn_43998 = (function (this$){
var x__4550__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_body$dyn_43998(this$);
}
});

var ajax$protocols$AjaxResponse$_get_response_header$dyn_43999 = (function (this$,header){
var x__4550__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_get_response_header$dyn_43999(this$,header);
}
});

var ajax$protocols$AjaxResponse$_was_aborted$dyn_44000 = (function (this$){
var x__4550__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_was_aborted$dyn_44000(this$);
}
});
...
var ajax$protocols$Interceptor$_process_request$dyn_44001 = (function (this$,request){
var x__4550__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$Interceptor$_process_request$dyn_44001(this$,request);
}
});

var ajax$protocols$Interceptor$_process_response$dyn_44002 = (function (this$,response){
var x__4550__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$Interceptor$_process_response$dyn_44002(this$,response);
}
});
...
(ajax.protocols.Response.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4504__auto__,k43975,else__4505__auto__){
var self__ = this;
var this__4504__auto____$1 = this;
var G__43981 = k43975;
var G__43981__$1 = (((G__43981 instanceof cljs.core.Keyword))?G__43981.fqn:null);
switch (G__43981__$1) {
case "status":
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k43975,else__4505__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4525__auto__,p__43983){
var vec__43984 = p__43983;
var k__4526__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43984,(0),null);
var v__4527__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43984,(1),null);
...
(ajax.protocols.Response.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__43974){
var self__ = this;
var G__43974__$1 = this;
return (new cljs.core.RecordIter((0),G__43974__$1,5,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"status","status",-1997798413),new cljs.core.Keyword(null,"body","body",-2049205669),new cljs.core.Keyword(null,"status-text","status-text",-1834235478),new cljs.core.Keyword(null,"headers","headers",-835030129),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(ajax.protocols.Response.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this43976,other43977){
var self__ = this;
var this43976__$1 = this;
return (((!((other43977 == null)))) && ((((this43976__$1.constructor === other43977.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this43976__$1.status,other43977.status)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this43976__$1.body,other43977.body)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this43976__$1.status_text,other43977.status_text)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this43976__$1.headers,other43977.headers)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this43976__$1.was_aborted,other43977.was_aborted)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this43976__$1.__extmap,other43977.__extmap)))))))))))))));
}));
...
(ajax.protocols.Response.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__4509__auto__,k43975){
var self__ = this;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k43975);

}
}));

(ajax.protocols.Response.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4510__auto__,k__4511__auto__,G__43974){
var self__ = this;
var this__4510__auto____$1 = this;
var pred__43989 = cljs.core.keyword_identical_QMARK_;
var expr__43990 = k__4511__auto__;
if(cljs.core.truth_((pred__43989.cljs$core$IFn$_invoke$arity$2 ? pred__43989.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"status","status",-1997798413),expr__43990) : pred__43989.call(null,new cljs.core.Keyword(null,"status","status",-1997798413),expr__43990)))){
return (new ajax.protocols.Response(G__43974,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__43989.cljs$core$IFn$_invoke$arity$2 ? pred__43989.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"body","body",-2049205669),expr__43990) : pred__43989.call(null,new cljs.core.Keyword(null,"body","body",-2049205669),expr__43990)))){
return (new ajax.protocols.Response(self__.status,G__43974,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__43989.cljs$core$IFn$_invoke$arity$2 ? pred__43989.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"status-text","status-text",-1834235478),expr__43990) : pred__43989.call(null,new cljs.core.Keyword(null,"status-text","status-text",-1834235478),expr__43990)))){
return (new ajax.protocols.Response(self__.status,self__.body,G__43974,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__43989.cljs$core$IFn$_invoke$arity$2 ? pred__43989.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"headers","headers",-835030129),expr__43990) : pred__43989.call(null,new cljs.core.Keyword(null,"headers","headers",-835030129),expr__43990)))){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,G__43974,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__43989.cljs$core$IFn$_invoke$arity$2 ? pred__43989.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828),expr__43990) : pred__43989.call(null,new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828),expr__43990)))){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,G__43974,self__.__meta,self__.__extmap,null));
} else {
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4511__auto__,G__43974),null));
}
}
}
}
...
(ajax.protocols.Response.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4501__auto__,G__43974){
var self__ = this;
var this__4501__auto____$1 = this;
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,G__43974,self__.__extmap,self__.__hash));
}));
 ...
 */
ajax.protocols.map__GT_Response = (function ajax$protocols$map__GT_Response(G__43978){
var extmap__4542__auto__ = (function (){var G__43992 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__43978,new cljs.core.Keyword(null,"status","status",-1997798413),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"body","body",-2049205669),new cljs.core.Keyword(null,"status-text","status-text",-1834235478),new cljs.core.Keyword(null,"headers","headers",-835030129),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828)], 0));
if(cljs.core.record_QMARK_(G__43978)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__43992);
} else {
return G__43992;
}
})();
return (new ajax.protocols.Response(new cljs.core.Keyword(null,"status","status",-1997798413).cljs$core$IFn$_invoke$arity$1(G__43978),new cljs.core.Keyword(null,"body","body",-2049205669).cljs$core$IFn$_invoke$arity$1(G__43978),new cljs.core.Keyword(null,"status-text","status-text",-1834235478).cljs$core$IFn$_invoke$arity$1(G__43978),new cljs.core.Keyword(null,"headers","headers",-835030129).cljs$core$IFn$_invoke$arity$1(G__43978),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828).cljs$core$IFn$_invoke$arity$1(G__43978),null,cljs.core.not_empty(extmap__4542__auto__),null));
});
